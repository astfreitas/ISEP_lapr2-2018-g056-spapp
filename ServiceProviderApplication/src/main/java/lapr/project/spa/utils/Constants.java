...
public class Constants {
    ...
    public static final String PARAMS_NUMBER_OF_IMPORT_TYPES = "Company.QuantityImportTypesSupported";
    public static final String PARAMS_COMPANY_IMPORT_TYPE = "Company.ImportType";
